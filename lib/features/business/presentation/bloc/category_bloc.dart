...
class BusinessesByCategoryBloc
    extends Bloc<BusinessesByCategoryEvent, BusinessesByCategoryState> {
  final BusinessesByCategoryUseCase useCase;
  BusinessesByCategoryBloc({required this.useCase})
      : super(const BusinessesByCategoryInitial()) {
