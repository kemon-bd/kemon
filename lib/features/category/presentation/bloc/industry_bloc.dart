...
class CategoriesByIndustryBloc extends Bloc<CategoriesByIndustryEvent, CategoriesByIndustryState> {
  final CategoriesByIndustryUseCase useCase;
  CategoriesByIndustryBloc({required this.useCase}) : super(const CategoriesByIndustryInitial()) {
