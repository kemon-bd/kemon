...
class _ShareButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<FindIndustryBloc, FindIndustryState>(
      builder: (context, state) {
...
👀 Check out ${state.industry.name.full}(https://kemon.com.bd/category/${state.industry.urlSlug}) now and share your experience with the community!
...
#KemonApp #TrustedReviews #CommunityFirst #RealOpinions""",
              ...
              if (result.status == ShareResultStatus.success && context.mounted) {
                result.raw;
                context.successNotification(message: 'Thank you for sharing ${state.industry.name.full}');
              }
            },
          );
        }
      ...
      builder: (context, state) {
        ...
        if (state is FindIndustryDone) {
          return CachedNetworkImage(
            imageUrl: state.industry.icon.url,
