        ...
        onTap() {
          showModalBottomSheet(
            ...
            builder: (_) => BlocProvider(
              create: (_) => sl<FindReviewReactionsBloc>()..add(FindReviewReactions(review: review.identity)),
                      ...
                      children: [
                        WidgetSpan(
                          ...
                          child: InkWell(
                            ...
                            child: Text(
                              "${review.reactions} reaction${review.reactions > 1 ? 's' : ''}",
                              style: context.text.labelSmall?.copyWith(
                                color: theme.link,
                                fontWeight: FontWeight.bold,
                              ),
