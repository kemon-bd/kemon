...
class SubCategoryPage extends StatefulWidget {
  static const String path = '/sub-category/:urlSlug';
...
class _ShareButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<FindSubCategoryBloc, FindSubCategoryState>(
      builder: (context, state) {
...
👀 Check out ${state.subCategory.name.full}(https://kemon.com.bd/category/${state.subCategory.urlSlug}) now and share your experience with the community!
...
#KemonApp #TrustedReviews #CommunityFirst #RealOpinions""",
              ...
              if (result.status == ShareResultStatus.success && context.mounted) {
                result.raw;
                context.successNotification(message: 'Thank you for sharing ${state.subCategory.name.full}');
              }
            },
          );
        }
      ...
      builder: (context, state) {
        ...
        if (state is FindSubCategoryDone) {
          return CachedNetworkImage(
            imageUrl: state.subCategory.icon.url,
